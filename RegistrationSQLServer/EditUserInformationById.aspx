...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Panel ID="updateUserInfoPanel" runat="server">
                ...
                <br />
                <asp:HyperLink ID="registrationLink" NavigateUrl="~/Registration.aspx" Text="Back to Registration Page" runat="server"/>
                <br />
                <br />
